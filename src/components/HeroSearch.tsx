...
const ROUTES: RouteRow[] = [
  ...
  // —— ESP / wallhack / aimbot → product + forum + setup + hotkeys ——
  {
    ...
    href: PRODUCT,
    label: 'Rust Cheats product — ESP & features',
    meta: 'Product',
    priority: 100,
  },
  {
    ...
    label: 'Features list (forum guide)',
    meta: 'Forum',
    priority: 96,
  },
  {
    ...
    label: 'Features list → ESP / Aimbot checklist',
    meta: 'Forum',
    priority: 95,
  },
  {
    ...
    label: 'Complete setup — enable ESP after load',
    meta: 'Setup',
    priority: 92,
  },
  {
  ...
  },
  {
    keys: ['soft aim'],
    href: PRODUCT,
    label: 'Rust Cheats product — Soft aim',
    meta: 'Product',
    priority: 99,
  },
  {
  ...
  // —— Setup / load ——
  {
    ...
    label: 'Complete setup → Load order',
    meta: 'Setup',
    priority: 95,
  },
  {
    keys: ['steam', 'load', 'loading', 'loader'],
    href: PRODUCT,
    label: 'Product page — status before you load',
    meta: 'Product',
    priority: 88,
  },
  {
    ...
    href: blogPath('complete-setup'),
    label: 'How to Complete Rust Cheats Setup',
    meta: 'Setup',
    priority: 94,
  },
  {
    keys: ['setup', 'install', 'instructions', 'checklist'],
    href: PRODUCT,
    label: 'Buy Rust Cheats — then follow setup',
    meta: 'Product',
    priority: 86,
  },
  {
  ...
  },
  {
    ...
    label: 'How to Turn Off Antivirus',
    meta: 'Antivirus',
    priority: 95,
  },
  {
    ...
    href: '/status',
    label: 'Live status & dated changelog',
    meta: 'Status',
    priority: 98,
  },
  {
    ...
    label: 'Check Undetected Before You Buy',
    meta: 'Status',
    priority: 95,
  },
  {
    ...
    href: PRODUCT,
    label: 'Product page — live Undetected status',
    meta: 'Product',
    priority: 93,
  },
  {
    ...
    href: blogPath('features-list'),
    label: 'Features list — HWID spoofer',
    meta: 'Features',
    priority: 94,
  },
  {
    keys: ['spoofer', 'hwid', 'spoof'],
    href: PRODUCT,
    label: 'Product — ESP, aimbot & spoofer',
    meta: 'Product',
    priority: 90,
  },
]
